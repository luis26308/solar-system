...
function Neptune(props) {
    ...
    // const textureRef = useRef(new THREE.TextureLoader().load(imageBin.neptuneMap));
    const [textureMap, setTextureMap] = useState(new THREE.TextureLoader().load(imageBin.neptuneMap))
    ...
    return (
        <>
            <group>
                <Planet planetRef={planetRef} name={'Neptune'}>
