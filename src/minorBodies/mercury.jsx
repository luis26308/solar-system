...
function Mercury(props) {
    ...
    // const textureRef = useRef(new THREE.TextureLoader().load(imageBin.mercuryMap));
    const [textureMap, setTextureMap] = useState(new THREE.TextureLoader().load(imageBin.mercuryMap))
    ...
    return (
        <>
            <group>
                <Planet planetRef={planetRef} name={'Mercury'}>
