...
function Venus(props) {
    ...
    // const textureRef = useRef(new THREE.TextureLoader().load(imageBin.venusMap));
    const [textureMap, setTextureMap] = useState(new THREE.TextureLoader().load(imageBin.venusMap))
    ...
    return (
        <>
            <group> 
                <Planet planetRef={planetRef } name={'Venus'}>
