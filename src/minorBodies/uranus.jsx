...
function Uranus(props) {
    ...
    // const textureRef = useRef(new THREE.TextureLoader().load(imageBin.uranusMap));
    const [textureMap, setTextureMap] = useState(new THREE.TextureLoader().load(imageBin.uranusMap))
    ...
    return (
        <>
            <group>
                <Planet planetRef={planetRef} name={'Uranus'}>
