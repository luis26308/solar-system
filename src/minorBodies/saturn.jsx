...
function Saturn(props) {
    ...
    // const textureRef = useRef(new THREE.TextureLoader().load(imageBin.saturnMap));
    const [textureMap, setTextureMap] = useState(new THREE.TextureLoader().load(imageBin.saturnMap))
    ...
    return (
        <>
            <group ref={planetRef}>
                <Planet planetRef={planetRef} name={'Saturn'}>
