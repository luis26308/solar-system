...
function Mars(props) {
    ...
    // const textureRef = useRef(new THREE.TextureLoader().load(imageBin.marsMap));
    const [textureMap, setTextureMap] = useState(new THREE.TextureLoader().load(imageBin.marsMap))
    ...
    return (
        <>
            <group>
                <Planet planetRef={planetRef} name={'Mars'}>
